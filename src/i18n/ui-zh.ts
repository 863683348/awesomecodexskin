...
export const ui = {
  ...
  'site.description': '在一个中立索引中浏览、对比并触达所有 OpenAI Codex Desktop 与 CLI 皮肤、主题引擎与皮肤库。按氛围、颜色和平台筛选，复制一条命令即可免费安装。',
  'nav.skins': '皮肤',
  'nav.categories': '分类',
  'nav.blog': '博客',
  'nav.advertise': '广告',
  ...
  'skins.title': '全部 Codex 皮肤 — 免费下载 & 一条命令安装',
  'skins.description': '浏览所有 Codex Desktop 与 CLI 皮肤，复制一条命令即可安装。按分类、氛围、强调色和平台筛选，然后按最新或最热门排序。',
  ...
  'skin.installs': '约 {n} 次安装（估算）',
  'skin.likes': '约 {n} 次点赞（估算）',
