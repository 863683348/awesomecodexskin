...
faq:
  - q: "Is Codex Skin Manager free?"
    a: "Yes, Codex Skin Manager is free and open source."
  - q: "Does Codex Skin Manager work on macOS?"
    a: "Yes — macOS and Windows are both supported."
  - q: "Can I use Codex Skin Manager with Dream Skin installed?"
    a: "Yes, they coexist. Just designate one as the primary applier to avoid the last-one-wins conflict."
  - q: "Can I manage Codex CLI themes with Skin Manager?"
    a: "No — Skin Manager is for Codex Desktop. CLI themes need a CLI tool like Codex Themes CLI or Codepilot."
---
...
See the full [engine showdown](/blog/codex-dream-skin-vs-skin-manager/) for the side-by-side table, and [Best Codex Dream Skin Alternatives](/blog/codex-dream-skin-alternatives/) if you're weighing options beyond these two.
